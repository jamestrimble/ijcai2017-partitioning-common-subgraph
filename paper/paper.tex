...
\cref{sec:comparison}, the algorithm may be viewed as a version of the
...
calculated efficiently, since each label (in \cref{fig:alg3}) is prefixed
by the label at the previous level of the search tree (\cref{fig:alg2}).
