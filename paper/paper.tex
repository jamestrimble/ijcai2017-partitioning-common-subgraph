...
To summarise these experimental results, we find that \McSplit\ improves on the
...
\definecolor{myblue}{RGB}{240,240,240}
\definecolor{mygreen}{RGB}{120,120,120}
...
\caption{A bipartite graph of the type used to calculate a bound in CP-FC}
