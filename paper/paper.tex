...
\begin{figure}
    \centering
    \subfigure[][MCS unlabelled unconnected instances] {
        \centering
    ...
    \caption{Cumulative runtimes}\label{figure:mcs-cumulative}
\end{figure}
...
\begin{figure}
    ...
    \caption{Cumulative runtimes, connected variant}
...
\begin{figure}
    ...
    \caption{Cumulative runtimes, SIP instances}\label{figure:sip-cumulative}
\end{figure}
