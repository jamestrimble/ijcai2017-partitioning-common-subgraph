...
\paragraph{Vertex labels, edge labels, directed}
Cumulative run times for this class of instances are in \cref{figure:33ved-cumulative}.
Again, \McSplit\ is over an order of magnitude faster than the best CP algorithm,
which is CP-MAC in this case.  The clique encoding, however, outperforms the other
algorithms on these labelled instances, except in the easy region at the left
of the graph.  
