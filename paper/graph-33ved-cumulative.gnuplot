...
plot \
    ...
    "../experiments/gpgnode-results/mcs33ved/runtimes.data" u 5:($5>=1e6?1e-10:1) smooth cumulative w l ti columnhead(5) at end, \
    "../experiments/gpgnode-results/mcs33ved/runtimes.data" u 6:($6>=1e6?1e-10:1) smooth cumulative w l ti columnhead(6) at end, \
